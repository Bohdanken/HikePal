...
def ask_for_trails(parameters):
    request_str = f"Tell me 10 most popular trails (but not parks) within {parameters['radius']} kilometers of {parameters['city']} Please tell only names and coordinates, do not include any description. Please give your answer in the following format: NAME, (LATITUDE, LONGITUDE)"
    print(request_str)
